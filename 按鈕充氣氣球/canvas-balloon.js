...
/*
	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 230, 160, 'rgb(255, 0, 0)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 260, 140, 'rgb(255, 165, 0)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 290, 120, 'rgb(255, 255, 0)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 320, 100, 'rgb(100, 0, 100)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 350, 80, 'rgb(100, 50, 0)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 380, 60, 'rgb(100, 100, 0)');
	balloon1.draw();

	var balloon1 = new CANVASBALLOON.Balloon('canvas', 500, 410, 40, 'rgb(45, 100, 0)');
	balloon1.draw();
*/
